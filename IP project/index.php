    ...
    <div id="home"  class="home">
        ...
        <div class="left">
            ...
            <div class="buttons">
              ...
              <a class="button" href="index2.php" id="login" >login</a>
              <a   style="text-decoration:none; background-color: blue; padding: 10px; border-radius: 0.3cm; color: white;color:white; font-size: 22px;  
    text-transform: capitalize;" href="order.php">Order Now</a>
            </div>
          </div>
